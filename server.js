  ...
  try {
    ...
    console.log("✅ Préinscription enregistrée avec ID :", inscriptionId);
      ...
      const adminMailOptions = {
        ...
        subject: `Nouvelle Préinscription - ${nom || ''} ${prenom || ''}`, // Objet spécifique
      ...
      console.error("🚨 Erreur lors de la préinscription :", error.message);
      res.status(500).json({ success: false, message: "Erreur lors de la préinscription : " + error.message });
    } finally {
